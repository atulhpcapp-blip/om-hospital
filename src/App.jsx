  ...
  return(
    <div>
      ...
      {(()=>{
       ...
       <SecL>Today's income</SecL><div style={{borderRadius:18,overflow:'hidden',marginBottom:16,background:'linear-gradient(135deg,#0f172a,#1e3a5f)',padding:'18px'}}><div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10,marginBottom:12}}><div style={{background:'rgba(255,255,255,0.08)',borderRadius:10,padding:'10px'}}><div style={{fontSize:10,color:'rgba(255,255,255,0.5)',fontWeight:700,marginBottom:4}}>REAL INCOME</div><div style={{fontSize:20,fontWeight:900,color:'#4ade80'}}>{fmt(todayTotal-todayComm-todayVCFees)}</div></div><div style={{background:'rgba(255,255,255,0.08)',borderRadius:10,padding:'10px'}}><div style={{fontSize:10,color:'rgba(255,255,255,0.5)',fontWeight:700,marginBottom:4}}>ACTUAL INCOME</div><div style={{fontSize:20,fontWeight:900,color:'#34d399'}}>{fmt(todayTotal-todayComm-todayVCFees-todayExpTotal)}</div></div></div><div style={{fontSize:11,color:'rgba(255,255,255,0.4)',display:'flex',flexDirection:'column',gap:4}}><div style={{display:'flex',justifyContent:'space-between'}}><span>Gross</span><span style={{color:'rgba(255,255,255,0.8)'}}>{fmt(todayTotal)}</span></div><div style={{display:'flex',justifyContent:'space-between'}}><span>Commissions</span><span style={{color:'#fbbf24'}}>- {fmt(todayComm+todayVCFees)}</span></div><div style={{display:'flex',justifyContent:'space-between'}}><span>Expenses</span><span style={{color:'#f87171'}}>- {fmt(todayExpTotal)}</span></div></div></div>    {/* MEDICAL SUPPLIES */}
