...
const AnalyticsDash=({db})=>{
  ...
  return(
    <div>
     ...
     <SecL>Today's income</SecL><div style={{borderRadius:18,overflow:'hidden',marginBottom:16}}><div style={{background:'linear-gradient(135deg,#0f172a 0%,#1e3a5f 100%)',padding:'18px 20px'}}><div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12,marginBottom:14}}><div style={{background:'rgba(255,255,255,0.07)',borderRadius:12,padding:'12px'}}><div style={{fontSize:10,color:'rgba(255,255,255,0.5)',fontWeight:700,textTransform:'uppercase',marginBottom:4}}>Real income</div><div style={{fontSize:22,fontWeight:900,color:'#4ade80'}}>{fmt(todayTotal-todayComm-todayVCFees)}</div><div style={{fontSize:10,color:'rgba(255,255,255,0.35)',marginTop:3}}>After commissions</div></div><div style={{background:'rgba(255,255,255,0.07)',borderRadius:12,padding:'12px'}}><div style={{fontSize:10,color:'rgba(255,255,255,0.5)',fontWeight:700,textTransform:'uppercase',marginBottom:4}}>Actual income</div><div style={{fontSize:22,fontWeight:900,color:'#34d399'}}>{fmt(todayTotal-todayComm-todayVCFees-todayExpTotal)}</div><div style={{fontSize:10,color:'rgba(255,255,255,0.35)',marginTop:3}}>After all expenses</div></div></div></div></div>
      {/* MEDICAL SUPPLIES */}
